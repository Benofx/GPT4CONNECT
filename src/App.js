//Le manifest est hosté ici : https://static.tpionet.com/GPT4CONNECT/extension-manifest.json
...
class App extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      mainMenu: { title: "Chat GPT", icon: "https://static.tpionet.com/GPT4CONNECT/logo.png", command: "main_nav_menu_cliked", },
      /*subMenuItems: [
            ...
            case "extension.command":
              switch (args.data) {
                case "main_nav_menu_cliked":
                  this.setState({ title: "Chat GPT" });
                  this.setState({ link: "https://chat.openai.com/" });
                  break;
